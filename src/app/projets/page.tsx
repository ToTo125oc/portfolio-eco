...
export default function Projets() {
  return (
    <div className="flex flex-col items-center">
      <section className="mt-12 p- grid grid-cols-1 md:grid-cols-2 gap-4">
          <article className="p-2 border-4 border-green-800/100 bg-gray-900 rounded-xl w-96 h-96">
              <Image src={mararthon} alt="Pas d'image" style={{ width: "100%", height: "200px", objectFit: "cover" }} className="rounded-md"/>
          ...
          <article className="p-2  border-4 border-green-800/100 bg-gray-900 rounded-xl w-96 h-96">
            <Image src={raytracer} alt="Pas d'image" style={{ width: "100%", height: "200px", objectFit: "cover" }} className="rounded-md"/>
            <h3 className="text-xl font-bold">RayTracer</h3>
            <p>Réalisation d&apos;un Raytracer en Java avec l&apos;aide de patrons de conceptions</p>
          </article>
            <article className="p-2  border-4 border-green-800/100 bg-gray-900 rounded-xl w-96 h-96">
              <Image src={flatcraft} alt="Pas d'image" style={{ width: "100%", height: "200px", objectFit: "cover" }} className="rounded-md"/>
            ...
            <article className="p-2  border-4 border-green-800/100 bg-gray-900 rounded-xl w-96 h-96">
              <Image src={gds} alt="Pas d'image" style={{ width: "100%", height: "200px", objectFit: "cover" }} className="rounded-md"/>
